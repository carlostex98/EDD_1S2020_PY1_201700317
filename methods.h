...
void n_usuario(string us){
    arbol* ra=raiz;
    ra=agregar_usuario(ra,us);
    raiz=ra;
}*/
...
void iniciar_fichas(){
    ficha_aux(0,"a",1,12); ficha_aux(1,"e",1,12); ficha_aux(2,"o",1,9); ficha_aux(3,"i",1,6); ficha_aux(4,"s",1,6); ficha_aux(5,"n",1,5);
    ficha_aux(6,"l",1,4); ficha_aux(7,"r",1,5); ficha_aux(8,"u",1,5); ficha_aux(9,"t",1,4); ficha_aux(10,"a",2,5); ficha_aux(11,"a",2,2);
    ficha_aux(12,"c",3,4); ficha_aux(13,"b",3,2); ficha_aux(14,"m",3,2); ficha_aux(15,"p",3,2); ficha_aux(16,"h",4,2); ficha_aux(17,"f",4,1);
    ficha_aux(18,"v",4,1); ficha_aux(19,"y",4,1); ficha_aux(20,"q",5,1); ficha_aux(21,"j",8,1); ficha_aux(22,"ñ",8,1); ficha_aux(23,"z",10,1);
}
